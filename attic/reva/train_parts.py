...
from calibers.k1.decor import swirl_windows, wave_bridge_face
...
def esc_arbor():
    ...
    from calibers.k1.parameters import M3_LEVELS
    sections = [
        (pivot_r, 4.0),
...
def wave_bridge():
    ...
    from calibers.k1.decor import crest_frame, wave_tube_center
    from calibers.k1.parameters import m3_layout
    m = m3_layout()
...
def rig_plate():
    ...
    # --- Milestone 3 additions ---
    from calibers.k1.parameters import M3_LEVELS, m3_layout
    m = m3_layout()
    ...
    from calibers.k1.parameters import M4_LEVELS, m4_layout
    m4 = m4_layout()
