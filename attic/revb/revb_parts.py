...
from calibers.k1.parameters import ARBOR, TOL
...
def wave_bridge_b():
    ...
    from calibers.k1.decor import wave_bridge_face
    m = revb_layout()
    BAL = m["balance"]
...
def broad_wave_bridge():
    ...
    from math import cos, sin, radians
    from calibers.k1.decor import _ccw_polygon, _chaikin
    m = revb_layout()
    BAL = m["balance"]
    bx, by = m["barrel"]
...
def ratchet_b():
    ...
    from calibers.k1.decor import swirl_windows
...
def click_b():
    ...
    from calibers.k1.decor import _ccw_polygon
    g = click_geometry_b()
...
def _train_arbor(sections):
    from attic.reva.train_parts import _arbor_stack
...
def club_escape_wheel_b():
    ...
    from math import cos, pi, sin
    from build123d import Rectangle, Pos as P_
    from calibers.k1.decor import _ccw_polygon, swirl_windows
